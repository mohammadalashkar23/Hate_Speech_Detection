...
#   raw_data_df = pd.read_csv('/content/drive/MyDrive/Advanced_ML_Project/Offensive-Language-Detection-DL/data/dataset.csv') #change
  return raw_data_df
...
def preprocessing_tweet(tweet_df):
  temp_list= []
  for t in tweet_df['tweet']: #change 'tweet' instead of text
